...
// to make this work here. E.g. preflight.Results vs. certification.Resutls.
...
type ResponseFormatter interface {
	...
	Format(context.Context, preflight.Results) (response []byte, formattingError error)
}
...
type FormatterFunc = func(context.Context, preflight.Results) (response []byte, formattingError error)
...
func (f *genericFormatter) Format(ctx context.Context, r preflight.Results) ([]byte, error) {

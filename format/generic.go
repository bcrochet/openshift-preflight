...
func genericJSONFormatter(ctx context.Context, r preflight.Results) ([]byte, error) {
...
func genericXMLFormatter(ctx context.Context, r preflight.Results) ([]byte, error) {
	response := getResponse(r)
